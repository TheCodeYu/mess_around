    ...
    <div class="dev-detail" v-if="devPlugin.length">
      ...
      <div class="plugin-detail">
        <div class="plugin-top">
          ...
          <div class="right">
            <a-switch
              :checked="pluginDetail.status"
              @change="devPluginStatusChange(pluginDetail)"
            />
          </div>
        </div>
          ...
          <a-tab-pane key="1" tab="管理">
            <div class="desc-item">
              <div class="desc-title">
                <p>重新加载</p>
                <a-button type="link" @click="reloadDevPlugin(pluginDetail)"
                  >重载</a-button
                >
              </div>
              <div class="desc-info">
            ...
            <div class="desc-item">
              <div class="desc-title">
                <p>发布</p>
                <a-button @click="release(pluginDetail)" type="link"
                  >发布</a-button
                >
              </div>
              <div class="desc-info">
