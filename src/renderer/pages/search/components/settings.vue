  ...
  <div class="pg-settings">
    <div class="dev-detail">
      <a-menu
        ...
        mode="vertical"
      >
        <a-menu-item :key="0"> 偏好设置 </a-menu-item>
        <a-menu-item :key="1"> 全局快捷键 </a-menu-item>
        <a-menu-item :key="2"> 扩展设置 </a-menu-item>
      ...
      <div class="settings-detail">
          ...
          <div class="setting-item">
            ...
            <div class="settings-item-li">
              ...
              <div
                class="value"
                tabIndex="-1"
                @keydown="(e) => changeShortCut(e, 'showAndHidden')"
              >
            ...
            <div class="settings-item-li">
              ...
              <div
                class="value"
                tabIndex="-1"
                @keydown="(e) => changeShortCut(e, 'separate')"
              >
            ...
            <div class="settings-item-li">
              ...
              <div
                class="value"
                tabIndex="-1"
                @keydown="(e) => changeShortCut(e, 'quit')"
              >
        ...
        <div v-if="currentSelect[0] === 2" class="plugin-detail">
          <div class="detail-container" v-html="readme"></div>
        </div>
        <div v-if="currentSelect[0] === 3" class="plugin-detail">
          <div class="detail-container" v-html="readme"></div>
        </div>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    readme() {
      ...
      try {
        const mdFile = path.join(__static, "README.md");
